...
(function (process){
"use strict";function readify(r,e){check(r,e),readdir(r).then(getAllStats_(r,e)).catch(e)}function check(r,e){var t="path should be string!",i="callback should be function!";if("string"!=typeof r)throw Error(t);if("function"!=typeof e)throw Error(i)}function getAllStats(r,e,t){var i=t.length,n=format.addSlashToEnd(r);if(!i)return fillJSON(n,[],e);var o=t.map(function(r){return exec.with(getStat,r,n+r)});exec.parallel(o,function(){for(var r=arguments.length,t=Array(r),i=0;i<r;i++)t[i]=arguments[i];var o=t.slice(1);fillJSON(n,o,e)})}function emptyStat(){return{mode:0,size:0,mtime:0,isDirectory:function(){}}}function getStat(r,e,t){fs.stat(e,function(e){var i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:emptyStat();i.name=r,t(null,i)})}function parseStat(r){var e=Number(r.mode).toString(8),t=r.uid||"",i=Number(e)||"",n=r.isDirectory(),o=n?"dir":r.size,a=r.mtime?shortdate(r.mtime,{order:"little"}):"";return{name:r.name,size:format.size(o),date:a,owner:t,mode:i&&format.permissions.symbolic(i)}}function fillJSON(r,e,t){var i=squad(changeOrder,sortFiles,parseStats),n={path:"",files:i(e)};n.path=format.addSlashToEnd(r),changeUIDToName(n,function(r,e){n.files=e,t(null,n)})}function changeUIDToName(r,e){nicki?nicki(function(t,i){var n=void 0;n=t?r.files.slice():r.files.map(function(r){var e=r.owner;return i[e]&&(r.owner=i[e]),r}),e(t,n)}):e(null,r.files)}function isDir(r){return"dir"===r.size}function not(r){return function(){return!r.apply(void 0,arguments)}}function changeOrder(r){var e=not(isDir),t=r.filter(isDir),i=r.filter(e),n=t.concat(i);return n}var format=require("format-io"),exec=require("execon"),squad=require("squad"),shortdate=require("shortdate"),promisify=require("es6-promisify"),currify=require("currify"),WIN="win32"===process.platform,map=function(r,e){return e.map(r)},sort=function(r,e){return e.sort(r)},parseStats=exec.with(map,parseStat),getAllStats_=currify(getAllStats),fs=void 0,nicki=void 0;if(module.exports=readify,"undefined"!=typeof window){var Filer=require("filer");fs=new Filer.FileSystem}else fs=require("fs"),nicki=!WIN&&require("nicki");var readdir=promisify(fs.readdir,fs),sortFiles=exec.with(sort,function(r,e){return r.name>e.name?1:-1});
}).call(this,require('_process'))

},{"_process":39,"currify":5,"es6-promisify":8,"execon":9,"filer":23,"format-io":36,"fs":3,"nicki":undefined,"shortdate":40,"squad":41}]},{},["readify.js"])("readify.js")
});
