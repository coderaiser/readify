...
},{"util/":119}],2:[function(require,module,exports){
...
!function(e){"use strict";function r(){function e(e,r,t){var o,n,c=Array.prototype.indexOf,u=r.length,f=e.length,i=f<u,a=c.call(e);if(~a&&(n=a+1<=u),i||n)throw o=i?r[u-1]:r[a],Error(o+t)}function r(e){var r=new RegExp("\\s([a-zA-Z]+)"),t={}.toString.call(e),o=t.match(r)[1],n=o.toLowerCase();return n}var t=function r(t,o){var n=" could not be empty!";return o?e(t,o,n):Object.keys(t).forEach(function(e){if("undefined"==typeof t[e])throw Error(e+n)}),r};return t.check=t,t.type=function(e,o,n){var c=r(o)===n;if(!c)throw Error(e+" should be "+n);return t},t}"object"==typeof module&&module.exports?module.exports=new r:e.check||(e.check=new r)}(this);
...
"use strict";function _toConsumableArray(r){if(Array.isArray(r)){for(var n=0,t=Array(r.length);n<r.length;n++)t[n]=r[n];return t}return Array.from(r)}function check(r){if("function"!=typeof r)throw Error("fn should be function!")}var tail=function(r){return[].slice.call(r,1)},f=function(r){return[function(n){return r.apply(void 0,arguments)},function(n,t){return r.apply(void 0,arguments)},function(n,t,o){return r.apply(void 0,arguments)}]};module.exports=function r(n){check(n);var t=tail(arguments);if(t.length>=n.length)return n.apply(void 0,_toConsumableArray(t));var o=function(){return r.apply(void 0,[n].concat(_toConsumableArray(t),Array.prototype.slice.call(arguments)))},e=n.length-arguments.length,u=f(o)[e];return u};
...
},{"./debug":15,"_process":91}],15:[function(require,module,exports){
...
},{"ms":81}],16:[function(require,module,exports){
...
},{"_process":91}],17:[function(require,module,exports){
(function (global){
...
},{"_process":91}],22:[function(require,module,exports){
...
},{"_process":91}],26:[function(require,module,exports){
(function (Buffer){
...
(function (process){
function newError(a){return a&&"realpath"===a.syscall&&("ELOOP"===a.code||"ENOMEM"===a.code||"ENAMETOOLONG"===a.code)}function realpath(a,r,e){return ok?origRealpath(a,r,e):("function"==typeof r&&(e=r,r=null),void origRealpath(a,r,function(t,n){newError(t)?old.realpath(a,r,e):e(t,n)}))}function realpathSync(a,r){if(ok)return origRealpathSync(a,r);try{return origRealpathSync(a,r)}catch(e){if(newError(e))return old.realpathSync(a,r);throw e}}function monkeypatch(){fs.realpath=realpath,fs.realpathSync=realpathSync}function unmonkeypatch(){fs.realpath=origRealpath,fs.realpathSync=origRealpathSync}module.exports=realpath,realpath.realpath=realpath,realpath.sync=realpathSync,realpath.realpathSync=realpathSync,realpath.monkeypatch=monkeypatch,realpath.unmonkeypatch=unmonkeypatch;var fs=require("fs"),origRealpath=fs.realpath,origRealpathSync=fs.realpathSync,version=process.version,ok=/^v[0-5]\./.test(version),old=require("./old.js");
}).call(this,require('_process'))

},{"./old.js":49,"_process":91,"fs":7}],49:[function(require,module,exports){
(function (process){
function rethrow(){function e(e){e&&(n.message=e.message,e=n,t(e))}function t(e){if(e){if(process.throwDeprecation)throw e;if(!process.noDeprecation){var t="fs: missing callback "+(e.stack||e.message);process.traceDeprecation?console.trace(t):console.error(t)}}}var r;if(DEBUG){var n=new Error;r=e}else r=t;return r}function maybeCallback(e){return"function"==typeof e?e:rethrow()}var pathModule=require("path"),isWindows="win32"===process.platform,fs=require("fs"),DEBUG=process.env.NODE_DEBUG&&/fs/.test(process.env.NODE_DEBUG),normalize=pathModule.normalize;if(isWindows)var nextPartRe=/(.*?)(?:[\/\\]+|$)/g;else var nextPartRe=/(.*?)(?:[\/]+|$)/g;if(isWindows)var splitRootRe=/^(?:[a-zA-Z]:|[\\\/]{2}[^\\\/]+[\\\/][^\\\/]+)?[\\\/]*/;else var splitRootRe=/^[\/]*/;exports.realpathSync=function(e,t){function r(){var t=splitRootRe.exec(e);n=t[0].length,o=t[0],s=t[0],i="",isWindows&&!c[s]&&(fs.lstatSync(s),c[s]=!0)}if(e=pathModule.resolve(e),t&&Object.prototype.hasOwnProperty.call(t,e))return t[e];var n,o,s,i,a=e,l={},c={};for(r();n<e.length;){nextPartRe.lastIndex=n;var f=nextPartRe.exec(e);if(i=o,o+=f[0],s=i+f[1],n=nextPartRe.lastIndex,!(c[s]||t&&t[s]===s)){var u;if(t&&Object.prototype.hasOwnProperty.call(t,s))u=t[s];else{var p=fs.lstatSync(s);if(!p.isSymbolicLink()){c[s]=!0,t&&(t[s]=s);continue}var v=null;if(!isWindows){var d=p.dev.toString(32)+":"+p.ino.toString(32);l.hasOwnProperty(d)&&(v=l[d])}null===v&&(fs.statSync(s),v=fs.readlinkSync(s)),u=pathModule.resolve(i,v),t&&(t[s]=u),isWindows||(l[d]=v)}e=pathModule.resolve(u,e.slice(n)),r()}}return t&&(t[a]=e),e},exports.realpath=function(e,t,r){function n(){var t=splitRootRe.exec(e);l=t[0].length,c=t[0],f=t[0],u="",isWindows&&!d[f]?fs.lstat(f,function(e){return e?r(e):(d[f]=!0,void o())}):process.nextTick(o)}function o(){if(l>=e.length)return t&&(t[p]=e),r(null,e);nextPartRe.lastIndex=l;var n=nextPartRe.exec(e);return u=c,c+=n[0],f=u+n[1],l=nextPartRe.lastIndex,d[f]||t&&t[f]===f?process.nextTick(o):t&&Object.prototype.hasOwnProperty.call(t,f)?a(t[f]):fs.lstat(f,s)}function s(e,n){if(e)return r(e);if(!n.isSymbolicLink())return d[f]=!0,t&&(t[f]=f),process.nextTick(o);if(!isWindows){var s=n.dev.toString(32)+":"+n.ino.toString(32);if(v.hasOwnProperty(s))return i(null,v[s],f)}fs.stat(f,function(e){return e?r(e):void fs.readlink(f,function(e,t){isWindows||(v[s]=t),i(e,t)})})}function i(e,n,o){if(e)return r(e);var s=pathModule.resolve(u,n);t&&(t[o]=s),a(s)}function a(t){e=pathModule.resolve(t,e.slice(l)),n()}if("function"!=typeof r&&(r=maybeCallback(t),t=null),e=pathModule.resolve(e),t&&Object.prototype.hasOwnProperty.call(t,e))return process.nextTick(r.bind(null,null,t[e]));var l,c,f,u,p=e,v={},d={};n()};
}).call(this,require('_process'))

},{"_process":91,"fs":7,"path":88}],50:[function(require,module,exports){
(function (process){
...
},{"buffer":8,"string_decoder":110}],57:[function(require,module,exports){
(function (Buffer){
...
},{"../encodings":55,"./bom-handling":70,"./extend-node":71,"./streams":73,"_process":91,"buffer":8}],73:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":8,"stream":109}],74:[function(require,module,exports){
...
"use strict";function parse(n){var r={};return n.split("\n").forEach(function(n){var s=n.split(" "),e=s.length-1,o=s[e],t=s[0];o&&(r[o]=t)}),r}var spawnify=require("spawnify/legacy");module.exports=function(n){var r="dscl . -list /Users UniqueID | sort -nk 2",s=spawnify(r);s.on("error",function(r){n(r)});var e="";s.on("data",function(n){e+=n}),s.on("close",function(){n(null,parse(e))})},module.exports.parse=parse;
},{"spawnify/legacy":106}],83:[function(require,module,exports){
module.exports=require("./nicki");
},{"./nicki":84}],84:[function(require,module,exports){
(function (process){
"use strict";function read(e){fs.readFile(FILE,"utf8",function(r,s){r||(Names=get(s)),e(r,Names)})}function get(e){var r={};return e.split("\n").forEach(function(s){e=e.replace(s,"");var n=s.substr(s,s.indexOf(":"));s=s.replace(n+":x:","");var a=s.substr(s,s.indexOf(":"));a&&(r[a]=n)}),r}var fs=require("fs"),ischanged=require("ischanged"),FILE="/etc/passwd",DARWIN="darwin"===process.platform,Names;module.exports=function(e){if(DARWIN){if(Names)return e(null,Names);require("./darwin")(function(r,s){Names=s,e(r,s)})}else ischanged(FILE,function(r,s){return r?e(r):s||!Names?read(e):void e(null,Names)})},module.exports.parse=get;
}).call(this,require('_process'))

},{"./darwin":82,"_process":91,"fs":7,"ischanged":78}],85:[function(require,module,exports){
...
},{"wrappy":122}],86:[function(require,module,exports){
...
(function (process){
"use strict";function homedir(){var o=process.env,r=o.HOME,e=o.LOGNAME||o.USER||o.LNAME||o.USERNAME;return"win32"===process.platform?o.USERPROFILE||o.HOMEDRIVE+o.HOMEPATH||r||null:"darwin"===process.platform?r||(e?"/Users/"+e:null):"linux"===process.platform?r||(0===process.getuid()?"/root":e?"/home/"+e:null):r||null}var os=require("os");module.exports="function"==typeof os.homedir?os.homedir:homedir;
}).call(this,require('_process'))
...
(function (Buffer){
"use strict";function check(r,e,o){if(!r)throw Error("stream could not be empty!");if(!/string|buffer/.test(e))throw Error("type could be string or buffer only!");if(!o)throw Error("fn could not be empty!")}module.exports=function(r,e,o){function t(r){c+=r}function n(r){s.push(r)}function f(e){r.removeListener("data",u),r.removeListener("error",f),r.removeListener("end",f),o(e,i?c:Buffer.from(s))}void 0===o&&(o=e),o===e&&(e="buffer"),check(r,e,o);var i="string"===e,u=i?t:n,c="",s=[];r.on("data",u),r.on("error",f),r.on("end",f)};
}).call(this,require("buffer").Buffer)
...
},{"./_stream_readable":97,"./_stream_writable":99,"core-util-is":11,"inherits":76,"process-nextick-args":90}],96:[function(require,module,exports){
...
},{"./_stream_transform":98,"core-util-is":11,"inherits":76}],97:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":95,"_process":91,"buffer":8,"core-util-is":11,"events":19,"inherits":76,"isarray":77,"process-nextick-args":90,"stream":109,"string_decoder/":110,"util":6}],98:[function(require,module,exports){
...
},{"./_stream_duplex":95,"core-util-is":11,"inherits":76}],99:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":95,"_process":91,"buffer":8,"core-util-is":11,"events":19,"inherits":76,"process-nextick-args":90,"stream":109,"util-deprecate":116}],100:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":95,"./lib/_stream_passthrough.js":96,"./lib/_stream_readable.js":97,"./lib/_stream_transform.js":98,"./lib/_stream_writable.js":99,"stream":109}],102:[function(require,module,exports){
...
!function(){"use strict";function r(r){n(r);var t=o.readFileSync(r,"utf8"),e=JSON.parse(t);return e}function n(r){if("string"!=typeof r)throw Error("name should be string!")}function t(r){if("function"!=typeof r)throw Error("callback should be function!")}var o=require("fs"),e=require("try-catch");module.exports=function(r,u){n(r),t(u),o.readFile(r,"utf8",function(r,n){var t;r||(r=e(function(){t=JSON.parse(n)})),u(r,t)})},module.exports.sync=r,module.exports.sync.try=function(t){n(t);var o;return e(function(){o=r(t)}),o}}();
},{"fs":7,"try-catch":114}],105:[function(require,module,exports){
...
},{"./spawnify":107}],107:[function(require,module,exports){
(function (process){
"use strict";function Spawnify(t,e){var i=this;EventEmitter.call(this),process.nextTick(function(){i._onMessage(t,e)})}function getRegStrEnd(){var t=["s",";","&&","\\","|"],e=t.map(function(t){return"\\"+t}).join("|"),i="("+e+")";return i}function isContain(t,e){return assert(t,"str could not be empty!"),assert(e,"symbols could not be empty!"),e.some(function(e){return~t.indexOf(e)})}var path=require("path"),EventEmitter=require("events").EventEmitter,util=require("util"),assert=require("assert"),child_process=require("child_process"),exec=child_process.exec,tryCatch=require("try-catch"),tildify=require("tildify"),untildify=require("untildify"),WIN="win32"===process.platform,spawn=child_process.spawn,find=require("glob"),win=require("win32/legacy"),newLine=function(t){return t.message+="\n",t};util.inherits(Spawnify,EventEmitter),win.prepareCodePage(),module.exports=function(t,e){e=e||{},assert(t,"command could not be empty!"),e.cwd?e.cwd=untildify(e.cwd):e.cwd=process.cwd();var i=new Spawnify(t,e);return i},Spawnify.prototype._onMessage=function(t,e){var i,n=e.cwd,r=win.isChangeVolume(t),o=/^cd ?/,s=/^cd ?/i,c=o.test(t),a=s.test(t),u=["~",">","<","#","*","&","{","}","|","'",'"',";","`","$"],p=isContain(t,u);assert(t,"command could not be empty!"),assert(t,"options could not be empty!"),c||a&&WIN||r?(t=t.replace(WIN?s:o,""),this._onCD(t,n)):(WIN&&(t="cmd /C "+t),i=t[0]," "===i||p?this._set("exec",t,e):this._set("spawn",t,e))},Spawnify.prototype._emit=function(t,e){var i=this,n=function(t){var e=i.listeners(t);return e.length};assert(t,"event could not be empty!"),(n(t)||"error"===t)&&(this.emit(t,e),"error"===t&&"EACCES"===e.code&&(n("close")&&this.emit("close"),n("exit")&&this.emit("exit")))},Spawnify.prototype._set=function(t,e,i){var n,r,o;switch(assert(t,"event could not be empty!"),assert(e,"command could not be empty!"),assert(i,"options could not be empty!"),i.encoding="buffer",t){default:throw Error("type could be exec or spawn only!");case"exec":r=tryCatch(function(){o=exec(e,i)});break;case"spawn":n=e.split(" "),e=n.shift(),r=tryCatch(function(){o=spawn(e,n,i)})}r?("ENOTDIR"===r.code&&(r.message+=": "+i.cwd),this._emit("error",newLine(r)),this._emit("close"),this._emit("exit")):(this._setListeners(o),this.on("kill",function(t){o.kill(t)}),this.on("write",function(t){o.stdin.write(t)}),this._emit("start"))},Spawnify.prototype.kill=function(t){this._emit("kill",t)},Spawnify.prototype.write=function(t){this._emit("write",t)},Spawnify.prototype._setListeners=function(t){var e=this;assert(t,"child could not be empty!"),t.stdin&&t.stdin.on("error",function(t){e._emit("error",newLine(t))}),t.stdout&&(t.stdout.pipe(win.unicodify()).setEncoding("utf8").on("data",function(t){e._emit("data",t)}),t.stdout.on("error",function(t){e._emit("error",newLine(t))})),t.stderr&&(t.stderr.pipe(win.unicodify()).setEncoding("utf8").on("data",function(t){e._emit("error",Error(t))}),t.stderr.on("error",function(t){e._emit("error",newLine(t))})),t.on("error",function(t){e._emit("error",newLine(t))}),t.on("exit",function(){t=null,e._emit("exit")}),t.on("close",function(){t=null,e._emit("close")})},Spawnify.prototype._onCD=function(t,e){var i,n,r,o,s,c=this,a="cd ",u=win.isChangeVolume(t),p=win.isVolume(t),d=RegExp("^[/\\\\]");this.on("error",function(){i=!0}),this.on("close",function(){i||this._emit("path",tildify(r))}),r=untildify(t),o=isContain(r,["*","?"]),r||WIN||(r="."),u&&!p||(r=this._getFirstWord(r),r=path.normalize(r),s=d.test(r),n=[a,r,"'"+r+"'",'"'+r+'"'],n.forEach(function(e){t=t.replace(e,"")}),s||(r=path.join(e,r)),t=o?a+r+" "+t:a+'"'+r+'" '+t),o?find(r,function(e,i){var n;e||(n=i[0]),r=n,c._set("exec",t,{cwd:n})}):this._set("exec",t,{cwd:r})},Spawnify.prototype._getFirstWord=function(t){var e,i,n=getRegStrEnd(),r="^(.*?)",o='^"(.*)"',s=RegExp(r+n),c=RegExp(o+n+"?"),a="string"==typeof t;return a&&(i=t.match(c),i?e=i[1]:(i=t.match(s),e=i&&i[1]),e||(e=t)),e};
}).call(this,require('_process'))

},{"_process":91,"assert":1,"child_process":7,"events":19,"glob":51,"path":88,"tildify":112,"try-catch":114,"untildify":115,"util":119,"win32/legacy":120}],108:[function(require,module,exports){
...
},{"events":19,"inherits":76,"readable-stream/duplex.js":94,"readable-stream/passthrough.js":100,"readable-stream/readable.js":101,"readable-stream/transform.js":102,"readable-stream/writable.js":103}],110:[function(require,module,exports){
...
},{"_process":91,"readable-stream/transform":102,"util":119,"xtend":124}],112:[function(require,module,exports){
"use strict";var path=require("path"),osHomedir=require("os-homedir"),home=osHomedir();module.exports=function(e){return e=path.normalize(e)+path.sep,(0===e.indexOf(home)?e.replace(home+path.sep,"~"+path.sep):e).slice(0,-1)};
},{"os-homedir":87,"path":88}],113:[function(require,module,exports){
!function(){"use strict";var r=require("fs"),t="could not be empty!";module.exports=function(e,o,i){var a="raw"===o;if(i||(i=o),!e)throw Error("filename"+t);if(!i)throw Error("callback"+t);r.stat(e,function(r,t){var e,o;r||(e=t.mtime,o=a?e.getTime():e),i(r,o)})}}();
},{"fs":7}],114:[function(require,module,exports){
!function(t){"use strict";function o(t){var o;try{t()}catch(t){o=t}return o}void 0!==typeof module&&module.exports?module.exports=o:t.tryCatch=o}(this);
},{}],115:[function(require,module,exports){
"use strict";var osHomedir=require("os-homedir"),home=osHomedir();module.exports=function(e){if("string"!=typeof e)throw new TypeError("Expected a string");return home?e.replace(/^~($|\/|\\)/,home+"$1"):e};
},{"os-homedir":87}],116:[function(require,module,exports){
(function (global){
...
},{"./support/isBuffer":118,"_process":91,"inherits":117}],120:[function(require,module,exports){
module.exports=require("./win");
},{"./win":121}],121:[function(require,module,exports){
(function (process){
"use strict";function unicodify(){return WIN&&"65001"!==chcp()?iconv.decodeStream("cp"+(chcp()||CHCP)):through()}function getVolumes(e){var r=spawn("wmic",["logicaldisk","get","name"]);assert(e,"callback could not be empty!"),r.stdin.end(),pullout(r.stdout,"string",function(r,o){r?e(r):parse(o,e)}),r.stderr.on("data",e),r.on("error",e)}function parse(e,r){var o=/Name|\r| |\n/g;if(!e)return r(null,[]);var n=e.replace(o,"").split(":");n.pop(),r(null,n)}function prepareCodePage(){"win32"===process.platform&&getCodePage(function(e){e&&(process.on("SIGINT",function(){exec("chcp "+e,function(){process.exit()})}),exec("chcp 65001",function(){getCodePage(chcp)}))})}function getCodePage(e){exec("chcp",function(r,o,n){if(!r&&!n&&o){var t=o.indexOf(":"),c=o.slice(t+2).replace("\r\n","");e(c)}})}function isVolume(e){if(assert(e,"command could not be empty!"),WIN){var r=new RegExp(WIN_VOLUME+"\\\\.*","i");return e.match(r)}}function isChangeVolume(e){if(assert(e,"command could not be empty!"),WIN){var r=new RegExp(WIN_VOLUME,"i");return e.match(r)}}function store(){var e;return function(r){return r&&(e=r),e}}var spawn=require("child_process").spawn,exec=require("child_process").exec,assert=require("assert"),pullout=require("pullout/legacy"),through=require("through2"),iconv=require("iconv-lite"),WIN="win32"===process.platform,WIN_VOLUME="^[a-z]{1}:$",chcp=store(),CHCP="cp437";exports.getVolumes=getVolumes,exports.prepareCodePage=prepareCodePage,exports.isVolume=isVolume,exports.isChangeVolume=isChangeVolume,exports.unicodify=unicodify;
}).call(this,require('_process'))

},{"_process":91,"assert":1,"child_process":7,"iconv-lite":72,"pullout/legacy":92,"through2":111}],122:[function(require,module,exports){
...
"use strict";function sync(e,t,r){r=r||{},check(e,t,r),fs.writeFileSync(e,stringify(t,r))}function defaultOptions(e){return"undefined"==typeof e.space&&(e.space=4),"undefined"==typeof e.eof&&(e.eof=!0),e}function stringify(e,t){var r;return defaultOptions(t),r=JSON.stringify(e,t.replacer,t.space),t.eof&&(r+="\n"),r}function check(e,t,r){if("string"!=typeof e)throw Error("name should be string!");if("object"!=typeof t)throw Error("json should be object!");if("object"!=typeof r)throw Error("options should be object!")}function checkCB(e){if("function"!=typeof e)throw Error("callback should be function!")}var fs=require("fs"),tryCatch=require("try-catch");module.exports=function(e,t,r,o){var n;o||(o=r,r={}),check(e,t,r),checkCB(o),n=stringify(t,r),fs.writeFile(e,n,o)},module.exports.sync=sync,module.exports.sync.try=function(e,t,r){var o;return r=r||{},check(e,t,r),o=tryCatch(function(){sync(e,t,r)})};
},{"fs":7,"try-catch":114}],124:[function(require,module,exports){
function extend(){for(var r={},e=0;e<arguments.length;e++){var t=arguments[e];for(var n in t)hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r}module.exports=extend;var hasOwnProperty=Object.prototype.hasOwnProperty;
},{}],125:[function(require,module,exports){
module.exports=require("./lib/zames");
},{"./lib/zames":126}],126:[function(require,module,exports){
"use strict";function check(r){if("function"!=typeof r)throw Error("fn should be a function!")}function checkCount(r){if(r>4)throw Error("fn takes to much arguments, up to 4 supported")}var promisify=require("es6-promisify"),currify=require("currify/legacy");module.exports=function(r,n){check(r),checkCount(r.length);var t=[function(t){return promisify(r,n)(t)},function(t,i){return promisify(r,n)(t,i)},function(t,i,o){return promisify(r,n)(t,i,o)}],i=r.length-2;return currify(t[i])};
},{"currify/legacy":12,"es6-promisify":18}],"readify.js":[function(require,module,exports){
(function (process){
"use strict";function _defineProperty(r,e,t){return e in r?Object.defineProperty(r,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):r[e]=t,r}function readify(r,e,t){t||(t=e,e=""),check(r,t),readdir(r).then(getAllStats(r,e)).then(good(t)).catch(t)}function check(r,e){var t="path should be string!",i="callback should be function!";if("string"!=typeof r)throw Error(t);if("function"!=typeof e)throw Error(i)}function _getAllStats(r,e,t,i){var n=t.length,a=format.addSlashToEnd(r);if(!n)return fillJSON(a,[],e,i);var o=t.map(function(r){return getStat(r,a+r)});exec.parallel(o,function(){for(var r=arguments.length,t=Array(r),n=0;n<r;n++)t[n]=arguments[n];var o=t.slice(1);fillJSON(a,o,e,i)})}function emptyStat(){return{mode:0,size:0,mtime:0,uid:0,isDirectory:function(){}}}function _getStat(r,e,t){fs.stat(e,function(e){var i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:emptyStat();i.name=r,t(null,i)})}function _parseAllStats(r,e){return e.map(function(e){return parseStat(r,e)})}function parseStat(r,e){var t=e.isDirectory(),i=t?"dir":e.size;if("raw"===r)return{name:e.name,size:i,date:e.mtime,owner:e.uid,mode:e.mode};var n=Number(e.mode).toString(8),a=e.uid,o=Number(n)||"",u=e.mtime?shortdate(e.mtime,{order:"little"}):"";return{name:e.name,size:format.size(i),date:u,owner:a,mode:o&&format.permissions.symbolic(o)}}function fillJSON(r,e,t,i){var n=squad(changeOrder,sortFiles,parseAllStats(t)),a={path:"",files:n(e)};return a.path=format.addSlashToEnd(r),"raw"===t?i(null,a):void changeUIDToName(a,function(r,e){a.files=e||a.files,i(null,a)})}function changeUIDToName(r,e){nicki?nicki(function(t,i){if(t)return e(t);var n=replaceFromList(i,"owner",r.files);e(null,n)}):e(null,r.files)}function isDir(r){return"dir"===r.size}function not(r){return function(){return!r.apply(void 0,arguments)}}function changeOrder(r){var e=not(isDir),t=r.filter(isDir),i=r.filter(e),n=t.concat(i);return n}function replaceFromList(r,e,t){return t.map(function(t){var i=t[e],n=r[i];return n?Object.assign(t,_defineProperty({},e,n)):t})}var format=require("format-io"),exec=require("execon"),squad=require("squad"),shortdate=require("shortdate"),promisify=require("es6-promisify"),currify=require("currify/legacy"),zames=require("zames/legacy"),WIN="win32"===process.platform,BROWSER="undefined"!=typeof window,sort=currify(function(r,e){return e.sort(r)}),getStat=currify(_getStat),parseAllStats=currify(_parseAllStats),getAllStats=zames(_getAllStats),getFS=function(){if(!BROWSER)return require("fs");var r=require("filer");return new r.FileSystem},fs=getFS(),nicki=!WIN&&!BROWSER&&require("nicki/legacy"),readdir=promisify(fs.readdir,fs),sortFiles=sort(function(r,e){return r.name.localeCompare(e.name)}),good=function(r){return function(){for(var e=arguments.length,t=Array(e),i=0;i<e;i++)t[i]=arguments[i];return r.apply(void 0,[null].concat(t))}};module.exports=readify;
}).call(this,require('_process'))

},{"_process":91,"currify/legacy":12,"es6-promisify":18,"execon":20,"filer":34,"format-io":47,"fs":7,"nicki/legacy":83,"shortdate":105,"squad":108,"zames/legacy":125}]},{},["readify.js"])("readify.js")
});
